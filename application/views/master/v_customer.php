                    ...
                    <div class="row">
                        ...
                        <tbody>
                            ...
                            foreach($cust as $row){ 
                                ...
                                <tr>
                                    <td><?= $a;?></td>
                                    <td><?= $row->kode_cust;?><br><span class="badge badge-primary">Created By: <?= $row->created_by ?></span><br><span class="badge badge-primary">Created At: <?= date('d-m-Y',strtotime($row->created_at))?></span></td>
                                    <td><?= $row->nama; ?></td>
                                    <td><?= $row->kontak;?></td>
                                    <td><?= $row->alamat;?></td>
                                    <td><?= $row->kota;?></td>
    ...
    function simpan(){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: baseUrl + '/master/customer/save',
                    method: 'POST',
                    dataType: 'json',
                    data: $("#frm_new_cust").serialize(),
